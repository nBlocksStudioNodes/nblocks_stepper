...
void nBlock_STEPPER::init_TMC2130() {
    ...
    write_TMC2130(WRITE_FLAG|REG_IHOLD_IRUN, 0x00001800UL); // IRUN 0x0000 TO 0x1F00,  IHOLD=0x00 TO 0x1F, 
    ...
    write_TMC2130(WRITE_FLAG|REG_COOLCONF,   0x00070000UL);  // 0x0004E000UL
